...
```bash
INIT=$(node "/Users/patrykattc/work/git/rag-architecture-patterns/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/patrykattc/work/git/rag-architecture-patterns/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
