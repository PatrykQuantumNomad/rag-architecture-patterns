...
```
Agent(
  prompt="Read /Users/patrykattc/work/git/rag-architecture-patterns/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/patrykattc/work/git/rag-architecture-patterns/.cursor/get-shit-done/templates/SECURITY.md`
