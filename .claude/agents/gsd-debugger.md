...
<required_reading>
@/Users/patrykattc/work/git/rag-architecture-patterns/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/Users/patrykattc/work/git/rag-architecture-patterns/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/patrykattc/work/git/rag-architecture-patterns/.claude
                  → checks /Users/patrykattc/work/git/rag-architecture-patterns/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/patrykattc/work/git/rag-architecture-patterns/.claude/get-shit-done
                  → writes to /Users/patrykattc/work/git/rag-architecture-patterns/.claude/get-shit-done/hooks/
...
@/Users/patrykattc/work/git/rag-architecture-patterns/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/patrykattc/work/git/rag-architecture-patterns/.claude/get-shit-done/references/common-bug-patterns.md
