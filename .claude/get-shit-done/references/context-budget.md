...
The keys live in `.claude/settings.json` (project) or `/Users/patrykattc/work/git/rag-architecture-patterns/.claude/settings.json` (global) — **not** in `.planning/config.json`:
