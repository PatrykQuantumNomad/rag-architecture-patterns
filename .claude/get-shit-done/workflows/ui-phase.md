...
```markdown
Read /Users/patrykattc/work/git/rag-architecture-patterns/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/patrykattc/work/git/rag-architecture-patterns/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/patrykattc/work/git/rag-architecture-patterns/.claude/agents/gsd-ui-checker.md for instructions.
