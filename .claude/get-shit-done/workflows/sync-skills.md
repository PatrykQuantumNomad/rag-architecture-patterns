...
INSTALL_JS_GLOBAL="/Users/patrykattc/work/git/rag-architecture-patterns/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/patrykattc/work/git/rag-architecture-patterns/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
